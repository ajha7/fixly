...
class GptService(EventEmitter):
    ...
    def __init__(self):
        ...
        self.user_context = [
            ...
            If the provider can't give a price, ask for a typical price range and what factors affect it.
            When given a price, if the job requires it, ask: 'Does that price include materials/parts?' and 'What forms of payment do you accept?'
            Once pricing is clear, ask for earliest availability and whether weekend or evening appointments are possible.
